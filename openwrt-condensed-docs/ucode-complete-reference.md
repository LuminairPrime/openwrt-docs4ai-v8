...
- An [fs.file](/ucode-docs/ucode-module-fs.md), [fs.proc](/ucode-docs/ucode-module-fs.md), or socket resource
...
| NL80211_CMD_JOIN_IBSS | `number` | Join IBSS |
| NL80211_CMD_LEAVE_IBSS | `number` | Leave IBSS |
...
| NL80211_BSS_STATUS_IBSS_JOINED | `number` | Joined IBSS |
...
| Name | Type | Description |
| --- | --- | --- |
| NL80211_IFTYPE_ADHOC | `number` | IBSS/ad-hoc interface |
